...
from s14day5.home_work.atm.core import auth
from s14day5.home_work.atm.core import accounts
from s14day5.home_work.atm.core import logger
from s14day5.home_work.atm.core import transaction
import time
...
def run():
    ...
    :return:
    '''
    acc_data = auth.acc_login(user_data,access_logger)  #{"status": 0, "password": "abc", "expire_date": "2021-01-01", "balance": 16223.55, "pay_day": 22, "id": 1234, "enroll_date": "2016-01-02", "credit": 15000}
